...
<div style="font-size: 22px; float:left; width: 100%; font-weight: bold; padding-top: -15px; margin-bottom: 10px;">Objednavka č. <?=$cislo?></div>
...
<div style="float: left; font-size: 12px; padding-top: -10px;">
	<?
		...
		foreach ($objednavky_seznam as $ns)
		{
	?>		
