...
<div style="font-size: 22px; float:left; width: 100%; font-weight: bold; padding-top: -15px; margin-bottom: 10px;">Faktura prijata č. <?=$cislo?></div>
...
<div style="float: left; font-size: 12px; padding-top: -10px;">
	<?
		...
		foreach ($faktury_prijate_seznam as $ns)
		{
	?>		
	<div style="float: left; width: 50%;"><?=Seznam::seznamName($ns->seznam_id)?></div>
			<div style="float: left; width: 10%;"><?=$ns->pocet?> ks</div>
			<div style="float: left; width: 10%;"><?=number_format($ns->celkem, 2, ',', ' ')?></div>
			<div style="float: left; width: 10%;"><?=$ns->sazba_dph?></div>
			<div style="float: left; width: 10%;"><?=number_format($ns->celkem_dph, 2, ',', ' ')?></div>
			<div style="float: left; width: 10%;"><?=number_format($ns->vcetne_dph, 2, ',', ' ')?></div>
...
<div style="float: left; width: 50%;">
	<div style="padding-top: 50px;">MJ celkem: <b><?=array_sum($pocet)?></b> ks</div>
</div>
<div style="float: left; width: 50%;">
	<div style="padding-top: 40px; margin-left: 50px;">
		...
		<div style="float: left; width: 40%; text-align: right;">
			<b><?=number_format(array_sum($celkem), 2, ',', ' ')?></b> CZK<br />
			<b><?=number_format(array_sum($celkem_dph), 2, ',', ' ')?></b> CZK<br />
			<b><?=number_format(array_sum($vcetne_dph), 2, ',', ' ')?></b> CZK
		</div>
	</div>
</div>
