...
<div class="bdoklad-fz-form">
	...
	<div class="form-group field-modely required col-xs-2">
		<div class="form-group field-seznam-popis required">
			<label class="control-label" for="seznam-popis">Částka k zaplacení</label>
			<input id="seznam-popis" class="form-control" name="Castka" readonly="" maxlength="255" aria-required="true" type="text" value="<?= $fz['celkem_dph'] ?>">
			<div class="help-block"></div>
		</div>
	</div>
