...
<?php $form = ActiveForm::begin(); ?>
	...
	<div class="form-group field-dlist-prijaty-vystaveno required col-xs-2">
		<?php
			if (Yii::$app->controller->action->id == 'create')
			{
				if($obj['id'] > 0)
	...
	<? 
		if ($model->id > 0)
		{
			$countNS = DlistPrijatySeznam::getCountDlistPrijatySeznam($model->id);
		}
		else if($obj['id'] > 0)
		{
	...
	<div class="form-group col-xs-12" >
		<label class="control-label" for="nabidky-odberatel_id">Položky vystaveného dodacího listu</label> <span id="add_nabidka_polozka" data-count="<?=$countNS+1?>">Přidat položku</span>
...
if ($model->id > 0 || $obj['id'] > 0)
{
	if($model->id > 0)
	{
		$dataNS = DlistPrijatySeznam::getDlistPrijatySeznam($model->id);
	}
	else if ($obj['id'])
	{
...
?>
    ...
    <div class="form-group col-xs-12">
		<?= Html::a('Zpět', ['/dlist-prijaty/index'], ['class'=>'btn btn-success btn-100']) ?>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
