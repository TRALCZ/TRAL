 ...
 */
class DdokladFz extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['celkem', 'celkem_dph', 'user_id', 'datetime_add'], 'required'],
            [['celkem', 'celkem_dph', 'vystaveno', 'datetime_add'], 'safe'],
            [['cislo'], 'string', 'max' => 50],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'faktury_zalohove_id' => Yii::t('app', 'Faktura zálohová'),
    ...
    {
        return new DdokladFzQuery(get_called_class());
    }
