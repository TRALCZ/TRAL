 ...
 */
class BdokladFz extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['castka', 'user_id', 'datetime_add'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'castka' => Yii::t('app', 'Zaplacená částka'),
    ...
    {
        return new BdokladFzQuery(get_called_class());
    }
