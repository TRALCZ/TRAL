...
/**
 * This is the model class for table "dlist_prijaty".
 *
 * @property integer $id
 ...
 */
class DlistPrijaty extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
	...
	public static function addDlistPrijaty($objednavky_id, $cislo, $popis, $zpusoby_platby_id, $zakazniky_id, $user_id, $vystaveno, $platnost)
	{
		$faktury = new DlistPrijaty;
		...
		$ob = DlistPrijaty::findOne($lastId);
		$ob->cislo = "DLP-" . $lastId;
		$ob->update();
    ...
    /**
     * @inheritdoc
     * @return DlistPrijatyQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DlistPrijatyQuery(get_called_class());
    }
